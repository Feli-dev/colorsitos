    ...
    <Card>
      ...
      <CardContent className="space-y-8">
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-semibold">{t("showcase.buttons.title")}</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select>
                  ...
                  >
                    <SelectValue placeholder={t("showcase.forms.select.placeholder")} />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  style={{
                    ...
                    '--switch-bg': switchEnabled ? shades[500]?.hex : shades[300]?.hex,
                  }}
                />
                <label
                  style={{ color: shades[700]?.hex }}
                  className="text-sm font-medium"
                >
                  {switchEnabled ? t("showcase.forms.switch.on") : t("showcase.forms.switch.off")}
                </label>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div className="mt-2 flex gap-1">
                {([50, 100, 200] as const).map(value => (
                  <div
                    ...
                    style={{ backgroundColor: shades[value]?.hex }}
                  />
                ))}
              </div>
            </div>
            ...
            >
              ...
              <div className="mt-2 flex gap-1">
                {([700, 800, 900] as const).map(value => (
                  <div
                    key={value}
                    className="w-4 h-4 rounded"
                    style={{ backgroundColor: shades[value]?.hex }}
